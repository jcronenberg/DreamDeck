...
# DreamDeck modifications:
# Disabled all mouse_filter setting because we want to control what part of a node can be dragged and what can't
...
## (Optional) [ScrollContainer] reference. Normally, the addon will automatically check
